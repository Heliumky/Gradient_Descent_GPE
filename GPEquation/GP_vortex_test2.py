import sys, copy
sys.path.append('/home/chiamin/Downloads/GP/NumpyTensorTools/')
...
if __name__ == '__main__':    
    ...
    dt = dx**2
    print('dt',dt)
    psi_TDVP, ens_TDVP = imag_time_evol (H0, psi, g, dt, steps=100, maxdim=maxdim, cutoff=cutoff, krylovDim=krylovDim)
    ...
    gamma = dt*0.01
    print('gamma',gamma)
    psi_GD, ens_GD = gradient_descent (H0, psi, g, gamma, steps=1, maxdim=maxdim, cutoff=cutoff)
    #psi_GD[0] /= np.sqrt(dx**2)
